...
public class CpuCardSecretKeyHelper {
    ...
    /**
     * Call the{@link CardLanStandardBus#callRunDes(char, char, byte[], byte[], byte[])}. Gets the encrypted byte array
     *
     ...
     * {@link CardLanStandardBus#MacAnyLength(byte[] initIn, byte[] srcBytes, byte[] outBytes, byte[] keyBytes)}.
     * @param srcBytes
