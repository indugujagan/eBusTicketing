...
import za.co.jooce.ebus.devices.cardlan.secret.DESTwo;
import za.co.jooce.ebus.devices.cardlan.secret.ICardDataListener;
import za.co.jooce.ebus.devices.cardlan.thread.ReadCardNonUIThread;
import za.co.jooce.ebus.devices.cardlan.util.AbstractBaseLogClass;
import za.co.jooce.ebus.devices.cardlan.util.CardReadWriteUtil;
import za.co.jooce.ebus.devices.cardlan.util.CardlanLog;
import za.co.jooce.ebus.devices.cardlan.util.CpuCardSecretKeyHelper;
...
//                                    continue;
     ...
     * Corresponding buzzer
     */
    public void callProc(byte[] soundBytes) {
        writeProc(procpath, soundBytes);
        try {
            Thread.sleep(200);
        } catch (InterruptedException e) {
            e.printStackTrace();
