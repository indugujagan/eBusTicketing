package za.co.jooce.ebus.devices.cardlan.util;
...
public class CardReadWriteUtil {
    ...
    /**
     * Call the{@link CardLanStandardBus#callReadOneSectorDataFromCard(char SectorNo, char BlockNo, char VerifyFlag, byte[] key_array, char mode)},
    ...
    /**
     * Call the{@link CardLanStandardBus#callWriteOneSertorDataToCard(byte[] SectorArray, char SectorNo, char BlockNo, char VerifyFlag, byte[] key_array, char mode)},
     * Writes data to the card
     *
    ...
    /**
     * Call the{@link CardLanStandardBus#callInitDev()},
    ...
    /**
     * Call the{@link CardLanStandardBus#callCpuSendCmd(byte[] cmdArray, byte[] receiveArray)},
